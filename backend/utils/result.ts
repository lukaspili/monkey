...
// https://raw.githubusercontent.com/badrap/result/master/src/index.ts
...
export function isResult(obj: any): obj is Result<any, any> {
  if (!obj) {
    return false;
  }

  const shapeMatches = "isResult" in obj && "isOk" in obj && "isErr" in obj;
  if (!shapeMatches) {
    return false;
  }

  return obj.isResult === true;
}
