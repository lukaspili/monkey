        ...
        >
          <div className="relative flex flex-wrap gap-1">
            {selected.map((option) => {
              return (
                <div
                  key={option.value}
                  className={cn(
                    "focus:ring-ring inline-flex h-9 items-center rounded-md border px-2.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2",
                ...
                >
                  ...
                  >
                    <XMarkIcon className="text-muted-foreground hover:text-foreground h-3 w-3" />
                  </button>
                </div>
              );
            })}
            ...
            <CommandPrimitive.Input
              ...
              className={cn(
                "placeholder:text-muted-foreground h-9 flex-1 bg-transparent outline-none",
